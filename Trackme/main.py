...
def red():
    if True:
        clearme()
        window.configure(bg="white")
        rd1=Label(window,text="Hi, I'm trackle, your personal file guard!",font="none 20 bold italic",bg="white",fg="black")
        rd1.place(relx=0.5,rely=0.1,anchor="center")
        labels.append(rd1)
        rd2=Label(window,text="I can track the changes happening in a chosen directory and manage your files.",font="none 12 italic",bg="white",fg="black")
        rd2.place(relx=0.5,rely=0.2,anchor="center")
        labels.append(rd2)
        rd3=Label(window,text="All changes in this directory will be logged in dev.log",font="none 9 italic",fg="black",bg="white")
        rd3.place(relx=0.5,rely=0.35,anchor="center")
        labels.append(rd3)
        rd4=Label(window,text="Deleted files are NOT going to the Recycle Bin.",font="none 9 italic",fg="black",bg="white")
        rd4.place(relx=0.5,rely=0.45,anchor="center")
        labels.append(rd4)
        rd5=Label(window,text="Note: Read the titles of the windows.",font="none 9 italic",fg="black",bg="white")
        rd5.place(relx=0.15,rely=0.9,anchor="center")
        labels.append(rd5)
        rd6=Label(window,text="Made by 3maar, all rights reserved.",font="none 9 italic",fg="black",bg="white")
        rd6.place(relx=0.15,rely=0.85,anchor="center")
        labels.append(rd6)
        rd7=Label(window,text="For a similar TUI project that uses a bit more memory, check: https://github.com/3maar1/Trackle",font = "none 9 italic",fg="black",bg="white")
