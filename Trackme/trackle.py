...
def dark():
    if True:
        ...
        dk7.place(relx=0,rely=0.8,anchor="w")
        labels.append(dk7)
def light():
    if True:
        clearme()
        ...
        lt7.place(relx=0,rely=0.8,anchor="w")
        labels.append(lt7)
def red():
    if True:
        clearme()
        ...
        rd7.place(relx=0,rely=0.8,anchor="w")
        labels.append(rd7)
#-------------------------------------------------------------------------------------------------------
# Theme
...
label7.place(relx=0,rely=0.8,anchor="w")
labels.append(label7)
#-------------------------------------------------------------------------------------------------------
# Functional
Button(window,text="MiniGame",command=rps).place(relx=0.5,rely=0.5,anchor="center")
Button(window,text="Track Activity",command=select).place(relx=0.5,rely=0.3,anchor="center")
Button(window,text="Delete File",command=delete).place(relx=0.5,rely=0.35,anchor="center")
Button(window,text="Move File",command=move).place(relx=0.5,rely=0.4,anchor="center")
Button(window,text="Rename File",command=rename).place(relx=0.5,rely=0.45,anchor="center")
Button(window,text="YT Downloader",command=yd).place(relx=0.5,rely=0.55,anchor="center")
Button(window,text="Password Manager",command=psw).place(relx=0.5,rely=0.6,anchor="center")
#-------------------------------------------------------------------------------------------------------
# Main Loop
window.mainloop()